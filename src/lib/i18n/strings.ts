export const strings = {
  ...
  race: {
    ...
    untilRace: "До гонки",
    untilSprintQualifying: "До спринт-кваліфікації",
    untilSprint: "До спринту",
  ...
  bio: {
    wins: "Перемоги",
    poles: "Поули",
    championships: "Чемпіонства",
    bestFinish: "Найкращий фініш",
    bestGrid: "Найкращий старт",
    born: "Дата народження",
    error: "Не вдалося завантажити дані. Спробуйте ще раз пізніше.",
    wiki: "Читати у Вікіпедії",
  },
  news: {
    title: "Новини F1",
